...
void GLESDebugDraw::DrawSegment(const b2Vec2& p1, const b2Vec2& p2, const b2Color& color)
{
	glColor4f(color.r, color.g, color.b,1);
	GLfloat				glVertices[] = {
		p1.x * PTM_RATIO, p1.y * PTM_RATIO,
		p2.x * PTM_RATIO, p2.y * PTM_RATIO
	};
	glVertexPointer(2, GL_FLOAT, 0, glVertices);
...
void GLESDebugDraw::DrawAABB(b2AABB* aabb, const b2Color& c)
{
	...
	GLfloat				glVertices[] = {
		aabb->lowerBound.x * PTM_RATIO, aabb->lowerBound.y * PTM_RATIO,
		aabb->upperBound.x * PTM_RATIO, aabb->lowerBound.y * PTM_RATIO,
		aabb->upperBound.x * PTM_RATIO, aabb->upperBound.y * PTM_RATIO,
		aabb->lowerBound.x * PTM_RATIO, aabb->upperBound.y * PTM_RATIO
	};
	glVertexPointer(2, GL_FLOAT, 0, glVertices);
